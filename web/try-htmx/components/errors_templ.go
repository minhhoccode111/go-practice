...
func Errors(s []string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<ul id=\"form-errors-list\" class=\"list-disc list-inside\">")
		if templ_7745c5c3_Err != nil {
		...
		for _, v := range s {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `components/errors.templ`, Line: 6, Col: 10}
			}
