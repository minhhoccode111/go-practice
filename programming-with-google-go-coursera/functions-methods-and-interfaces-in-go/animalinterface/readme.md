...
newanimal command by creating the new animal and printing “Created it!” on the
screen.
...
method should print the animal’s food, the Move() method should print the
animal’s locomotion, and the Speak() method should print the animal’s spoken
